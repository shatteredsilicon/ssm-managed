...
require (
	...
	github.com/shatteredsilicon/promconfig v2.2.2-0.20220621164816-92898df3db18+incompatible
	github.com/shatteredsilicon/snmp_exporter v0.21.1-0.20230902102824-f5efda8a883d
