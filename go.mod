...
require (
	...
	github.com/shatteredsilicon/promconfig v2.2.2-0.20240327223050-6d1a52f976a9+incompatible
	github.com/shatteredsilicon/snmp_exporter v0.21.1-0.20240417211706-fec909ce8ea6
