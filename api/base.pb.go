...
func (*BaseVersionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_base_83bada666bfda87e, []int{0}
}
...
func (*BaseVersionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_base_83bada666bfda87e, []int{1}
}
...
func init() { proto.RegisterFile("base.proto", fileDescriptor_base_83bada666bfda87e) }

var fileDescriptor_base_83bada666bfda87e = []byte{
