...
type RemoveServiceParams struct {
	...
	/*Body*/
	Body *models.APINodeRemoveServiceRequest
	/*Name*/
	Name string
...
func (o *RemoveServiceParams) WithBody(body *models.APINodeRemoveServiceRequest) *RemoveServiceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the remove service params
func (o *RemoveServiceParams) SetBody(body *models.APINodeRemoveServiceRequest) {
	o.Body = body
}

// WithName adds the name to the remove service params
func (o *RemoveServiceParams) WithName(name string) *RemoveServiceParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the remove service params
func (o *RemoveServiceParams) SetName(name string) {
	o.Name = name
}
