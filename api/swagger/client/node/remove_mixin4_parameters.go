...
// WithName adds the name to the remove mixin4 params
func (o *RemoveMixin4Params) WithName(name string) *RemoveMixin4Params {
	o.SetName(name)
	return o
}

// SetName adds the name to the remove mixin4 params
func (o *RemoveMixin4Params) SetName(name string) {
	o.Name = name
}
