...
// WithID adds the id to the remove mixin5 params
func (o *RemoveMixin5Params) WithID(id int32) *RemoveMixin5Params {
	o.SetID(id)
	return o
}

// SetID adds the id to the remove mixin5 params
func (o *RemoveMixin5Params) SetID(id int32) {
	o.ID = id
}
